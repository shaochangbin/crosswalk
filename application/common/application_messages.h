...
IPC_MESSAGE_CONTROL1(ApplicationMsg_ShouldSuspend,  // NOLINT(*)
                     int /* sequence_id**/)
...
IPC_MESSAGE_CONTROL0(ApplicationMsg_Suspend)  // NOLINT(*)

// The runtime process changes its mind about suspending the main document.
IPC_MESSAGE_CONTROL0(ApplicationMsg_CancelSuspend)  // NOLINT(*)

// Response to ApplicationMsg_ShouldSuspend.
IPC_MESSAGE_CONTROL1(ApplicationHostMsg_ShouldSuspendAck,  // NOLINT(*)
                     int /* sequence_id**/)

// Response to ApplicationMsg_Suspend.
IPC_MESSAGE_CONTROL0(ApplicationHostMsg_SuspendAck)  // NOLINT(*)
