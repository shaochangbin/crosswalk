...
#ifndef XWALK_RUNTIME_RENDERER_TIZEN_XWALK_RENDER_VIEW_EXT_H_
#define XWALK_RUNTIME_RENDERER_TIZEN_XWALK_RENDER_VIEW_EXT_H_
...
#endif  // XWALK_RUNTIME_RENDERER_TIZEN_XWALK_RENDER_VIEW_EXT_H_
